/********************************************************************
CSCI 480 - Assignment 5 (Part 2) - Semester (Spring) 2022
...
void *writer(void *param)
{
    ...
    int num = (long)param; //Id used for the writer
...
{
    //some local variables
    int num = (long)param; //Id used for the reader
    ...
    //Prints the amount of semaphores that are waiting
    string amountOfWriters = "There are still";
    string amountOfWriters2 = "writers waiting on the semaphore...";
    int remaining = (num_writers - num_readers);
    printf("%s %d %s \n", amountOfWriters.c_str(), remaining, amountOfWriters2.c_str());
...
int main(int argc, char* argv[])
{
    ...
    num_readers = readerQuantity;
    num_writers = writerQuantity;
