...
public class MileRedeemer                                   //Mile Redeemer class
{
    ...
    //Displays the details for each destination the User selects
    public Destination getDDetails(String desDeets)
    {
        for(Destination des : destinationArray)
        {
            if(desDeets.equalsIgnoreCase(des.getdName()))
            {
                return des;
